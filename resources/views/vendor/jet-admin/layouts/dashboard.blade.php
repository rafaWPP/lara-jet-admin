...
<script src="https://kit.fontawesome.com/faac731465.js" crossorigin="anonymous"></script>
    <!-- Scripts -->
...
.main-content {
    margin-top: 4rem; /* Adiciona uma margem superior para compensar a altura do header */
...
<body class="font-sans antialiased">
    ...
    <div x-data="{
        ...
        <div id="page-container"
            ...
            <!-- Page Sidebar -->
            <nav id="page-sidebar"
                class="fixed bottom-0 start-0 top-0 z-50 flex h-full w-70 flex-col bg-white transition-transform duration-500 ease-out dark:bg-slate-800 lg:w-64 lg:translate-x-0 lg:border-primary-900/10 ltr:lg:translate-x-0 ltr:lg:border-r-4 rtl:lg:translate-x-0 rtl:lg:border-l-4 dark:lg:border-slate-700/25"
                x-bind:class="{
                    ...
                    <button data-dropdown-toggle="user-dropdown"
                        ...
                        <div class="grow text-left leading-5">
                            <span class="text-sm">
                             ...
                             <span class="text-xs font-medium opacity-75">  {{ auth()->user()->email }}</span>
                        </div>
            ...
            <main id="page-content" class="max-w-full pt-20 lg:pt-0">
                 @if (isset($header))
                    <header id="fixed-header" class="bg-white dark:bg-gray-800 shadow fixed-header">
                ...
                @endif
                <!-- Page Section -->
                <div id="main-content"  class="container mx-auto p-4 lg:p-8 py-5">
                    {{ $slot }}
                </div>
                <!-- END Page Section -->
            </main>
