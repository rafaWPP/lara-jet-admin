<div class="flex flex-col gap-3">
    <div class="flex flex-col lg:flex-row gap-3">
        <input type="search"
               ...
               class="border border-neutral-200 shadow-sm rounded-md outline-none focus:border-blue-300 px-3 py-2  text-black transition ease-in-out dark:bg-neutral-800 dark:border-neutral-700 dark:focus:border-blue-600 dark:text-gray-500"
