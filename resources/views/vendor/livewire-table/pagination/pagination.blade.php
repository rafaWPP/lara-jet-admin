                ...
                <div class="flex justify-between">
                    <span>
                        @if ($paginator->onFirstPage())
                            <span
                                class="relative inline-flex items-center px-4 py-2 text-sm text-neutral-500 border border-neutral-200 rounded-md select-none dark:bg-neutral-800 dark:border-neutral-700">
